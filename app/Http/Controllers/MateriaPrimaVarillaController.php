...
class MateriaPrimaVarillaController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $totalStock = \App\Models\StockVarilla::where('id_materia_prima_varilla', $id)->sum('stock');
        if($totalStock>=$stock_global_Nuevo){
            $varilla->stock_global_actual = $totalStock-$stock_global_Nuevo;
            $varilla->save();
            //dd('se puede');
            ...
            $stocks = \App\Models\StockVarilla::where('id_materia_prima_varilla', $id)->orderBy('id', 'asc')->get();
